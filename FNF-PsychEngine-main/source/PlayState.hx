...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (curStage)
		{
			case 'owlHouse': //Week L
				var houseBG:BGSprite = new BGSprite('owl_house', -600, -200, 0.9, 0.9);
				add(houseBG);

				hootyBop = new BGSprite('hooty_bop', 450, 200, 0.9, 0.9, ['hooty bop']);
				hootyBop.setGraphicSize(Std.int(hootyBop.width * 0.9));
				hootyBop.updateHitbox();
				add(hootyBop);
